...
const LanguageSelector: React.FC<LanguageSwitcherProps> = ({ block }) => {
    ...
    const [locale, setLocale] = useState<Locale>(
        ['en-GB', 'zh-HK'].includes(router.locale as Locale) ? (router.locale as Locale) : locales.TRADITIONAL_CHINESE
    );
        ...
        <div className={block ? 'w-full' : 'min-w-[130px] w-full'}>
            ...
            >
                ...
                <Select.Option value="zh-HK">
                    <div className="flex items-center">
                        <Image height={16} width={16} src={hongKongFlagImage} className="h-4 mr-2" alt="简体中文" />
                        繁體中文
                    </div>
                </Select.Option>
            </Select>
