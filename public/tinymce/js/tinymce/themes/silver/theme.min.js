...
!(function () {
    ...
    const af = (e) => (t) => t.options.get(e),
        ...
        cf = (e) => {
            ...
            n('skin', { processor: (e) => s(e) || !1 === e, default: 'oxide' }),
                ...
                n('toolbar', {
                    processor: (e) =>
                        d(e) || s(e) || l(e) ? { value: e, valid: !0 } : { valid: !1, message: 'Must be a boolean, string or array.' },
                    default: !0,
                }),
                V(9, (e) => {
                                ...
                                e()
                                    .bind((e) => {
                                        return (
                                            (o = ym.getCurrent(e)),
                                            (n = new Error(
                                                `Cannot find a current component to extract the value from for form part '${t}': ` + na(e.element)
                                            )),
                ...
                Hs([
                    Ks(os(), (o, n) => {
                        n.event.raw.propertyName === e.dimension.property &&
                            (hO(o, e), t.isExpanded() && Ht(o.element, e.dimension.property), (t.isExpanded() ? e.onGrown : e.onShrunk)(o));
                    }),
                ]),
        }),
        _O = [
                                            ...
                                            (t) => {
                                                ...
                                                return 'file' === e
                                                    ? ((s = [n, p_(r, d_(t)), p_(r, q([m_(t), u_(t), g_(t)]))]),
                                                      j(s, (e, t) => (0 === e.length || 0 === t.length ? e.concat(t) : e.concat(a_, t)), []))
                                                    : n;
                                                var s;
                                            }
                                        );
    ...
    const RE = 'container',
        ...
        $E = (e) =>
            ym
                .getCurrent(e)
                .bind((e) =>
                    TO.isGrowing(e) || TO.hasGrown(e) ? ym.getCurrent(e).bind((e) => G(LE.getSlotNames(e), (t) => LE.isShowing(e, t))) : A.none()
                ),
        qE = la('FixSizeEvent'),
        XE = la('AutoSizeEvent');
    ...
    const JE = Ol({
        ...
        kA = x(
            [Ai(['closedClass', 'openClass', 'shrinkingClass', 'growingClass', 'overflowToggledClass']), Di('onOpened'), Di('onClosed')].concat(aA())
        ),
        CA = x([
            Lu({ factory: LT, schema: zT(), name: 'primary' }),
            Lu({
                    ...
                    const r = vM(e, 'NodeChange', (e) => {
                        ...
                        l = (t, r, s) => {
                            ...
                            o.onAction(m, s),
                                n.each((e) => {
                                    mu.setValue(e, m),
                                        r && (p.each((t) => (e.element.dom.selectionStart = t)), h.each((t) => (e.element.dom.selectionEnd = t)));
                                });
                        },
                        c = (e, t) => l((e, t) => e - t, e, t),
                        d = (e, t) => l((e, t) => e + t, e, t),
                        ...
                        i = q(
                            H(t, (t) =>
                                'contexttoolbar' === t.type
                                    ? ((t, o) => lD(e, { buttons: t, toolbar: o.items, allowToolbarGroups: !1 }, n.backstage, A.some(['form:'])))(
                                          r,
                                          t
                                      )
                                    ...
                                    const s = ((t) => {
                                            ...
                                            for (; n-- > 0; ) {
                                                ...
                                                if (
                                                    ...
                                                    const t = dx(e, s);
                                                    if ((t.isDefaultPrevented() || o.push({ name: t.name, element: s }), t.isPropagationStopped()))
                                                        break;
                                                }
                                            }
                                            var r;
    ...
    const rR = Ol({
        ...
        aR = (e, t, o) => {
            const n = Uh(
                mC.sketch((n) => ({ dom: { tag: 'div', classes: ['tox-form'].concat(e.classes) }, components: H(e.items, (e) => w_(n, e, t, o)) }))
            );
            return {
                ...
                Ve = function (e) {
                    ...
                    return e instanceof l && !Ae(e)
                        ...
                        ? (Y &&
                              ...
                              (t = QR(t, F, ' ')),
                              (t = QR(t, I, ' ')),
                              e.textContent !== t && (YR(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
    ...
    const MN = (e) => AN().sanitize(e),
        ...
        RN = (e, t) =>
            bF.parts.body({
                dom: { tag: 'div', classes: ['tox-dialog__body'] },
                components: [
                    { dom: { tag: 'div', classes: ['tox-dialog__body-content'] }, components: [{ dom: ZE(`<p>${MN(t.translate(e))}</p>`) }] },
                ],
            }),
        ...
        zN = (e) => {
            ...
            return bF.sketch({
                ...
                parts: {
                    blocker: { dom: ZE(`<div class="${o}"></div>`), components: [{ dom: { tag: 'div', classes: DN ? [n, n + '--opaque'] : [n] } }] },
                },
                dragBlockClass: o,
                modalBehaviours: kl([
                    eh.config({}),
                        ...
                        components: [
                            {
                                ...
                                components: [
                                    IC({ dom: { tag: 'iframe', attributes: { src: e.url } }, behaviours: kl([Jw.config({}), eh.config({})]) }),
                                ],
                            },
                        ],
