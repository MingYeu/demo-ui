...
!(function () {
                        ...
                        const t = [],
                            ...
                            o = (e, t) => {
                                ...
                                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), Ri(o) || n(Ti(Oi(o), !1))),
                                    t < e.data.length && (o.setStart(e, t), o.setEnd(e, t + 1), Ri(o) || n(Ti(Oi(o), !0)));
                            },
                            r = e.container(),
                            s = e.offset();
    ...
    const Au = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
        ...
        Om = (e, t, n, o = !1) => {
            ...
            return (
                ...
                (gm(l) || l.block_expand) &&
                    ((gm(l) && Xo(r) && 0 !== s) || (r = Rm(e, n, r, s, !0)), (gm(l) && Xo(a) && i !== a.data.length) || (a = Rm(e, n, a, i, !1))),
    ...
    const tf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
        ...
        af = {
            ...
            getWin: (e) => {
                const t = ((e) => e.match({ domRange: (e) => bn(e.startContainer), relative: (e, t) => rf.getStart(e), exact: (e, t, n, o) => e }))(
                    e
                );
                return _n(t);
            },
            ...
            n.on('focusin', () => {
                ...
                n.on('focusout', () => {
                    og.setEditorTimeout(n, () => {
                        const t = e.focusedEditor;
                        (ag(lg(n)) && t === n) || o(n, un),
                            ig(n, lg(n)) || t !== n || (n.dispatch('blur', { focusedEditor: null }), (e.focusedEditor = null));
                    });
                }),
                rg ||
                    ((rg = (t) => {
                    ...
                    ((e, t, n, o) => {
                        ...
                        return Sh(n, o).bind((o) =>
                            ms(o)
                                ? Nh(e, o)
                                : ((e, t, n, o, r) =>
                                      au(n, e.getBody(), r).bind((e) => Sh(t, bn(e.getNode())).bind((e) => (xn(e, o) ? I.none() : I.some(E)))))(
                                      e,
                                      n,
                                      t,
                                      o,
                                  ...
                                  au(n, e.getBody(), r).fold(
                                      ...
                                      (s) =>
                                          ((e, t, n, o) =>
                                              uu(e.dom)
                                                  .bind((r) =>
                                                      mu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r)))
                                                  )
                                                  .getOr(!0))(o, n, r, s)
                                              ? ((e, t) => Nh(e, t))(e, o)
                                              : ((e, t, n) =>
        ...
        Kh = (e) => {
            return e.length > 0 &&
                (!(n = e[e.length - 1]).firstChild ||
                    (C(null == (t = n) ? void 0 : t.firstChild) && t.firstChild === t.lastChild && ((e) => e.data === ur || nr(e))(t.firstChild)))
                ? e.slice(0, -1)
                : e;
            var t, n;
        },
                    ...
                    return ((e, t, n, o, r, s, a, i) => {
                        ...
                        if (n) {
                            ...
                            (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                                c &&
                                    u &&
                                    (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), gm(a) && Ib(e, a, 0, c));
                        }
                        return o;
                    })(e, s, i, o, o, 0, a, n);
                },
                                ...
                                ? (gm(s) || (mm(s) && s.wrapper)) &&
                                  ...
                                  ((e, t, n, o, r) => {
                                      ...
                                      (cb(e, s, n, o) && tv(e, t, o, r)) ||
                                          (t.merge_with_parents && s && e.dom.getParent(s, (s) => !!cb(e, s, n, o) && (tv(e, t, o, r), !0)));
                                  })(e, s, t, n, a),
                                  ((e, t, n, o) => {
                        ...
                        ? ((e, t, n) => {
                              ...
                              if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                                  ...
                                  (o && (null == s ? void 0 : s.data) === mb) ||
                                      ((c = e.getDoc()), (u = pb(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
            ...
            return (
                ...
                (!!/((java|vb)script|mhtml):/i.test(o) ||
                    (!e.allow_html_data_urls &&
                        (/^data:image\//i.test(o)
                            ? ((e, t) => (C(e) ? !e : !C(t) || !H(Ny, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o)
                            : /^data:/i.test(o))))
            );
        };
    class Ay {
                                ...
                                ((e, n) => {
                                    ...
                                    if (t.isValidChild(e.name, n.toLowerCase())) {
                                        for (; i; ) {
                                            const t = i.next;
                                            g(o, i)
                                                ? (l || ((l = new Ag(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i))
                                                : (d(l), (l = null)),
                                                (i = t);
                                        }
                                        d(l);
                ...
                undo: (t, n, o) =>
                    ((e, t, n, o) => {
                        ...
                        return (
                            ...
                            o.get() > 0 &&
                                (o.set(o.get() - 1), (r = t.data[o.get()]), fC(e, r, !0), e.setDirty(!0), e.dispatch('Undo', { level: r })),
                            r
                        );
                    })(e, t, n, o),
                redo: (t, n) =>
                    ((e, t, n) => {
                        ...
                        return (
                            t.get() < n.length - 1 &&
                                (t.set(t.get() + 1), (o = n[t.get()]), fC(e, o, !1), e.setDirty(!0), e.dispatch('Redo', { level: o })),
                            o
                        );
                    })(e, t, n),
                clear: (t, n) =>
    ...
    const gw = (e, t) => {
        ...
        Tw = [9, 27, qm.HOME, qm.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, qm.DOWN, qm.UP, qm.LEFT, qm.RIGHT].concat(
        ...
        ox = (e) => {
            ...
            return (
                !t.collapsed && (nx(e, !0).exists((e) => e.isEqual(Bi.fromRangeStart(t))) || nx(e, !1).exists((e) => e.isEqual(Bi.fromRangeEnd(t))))
            );
        },
        ...
        Fx = (e, t) =>
            e ? t.fold(S(I.some, xx.start), I.none, S(I.some, xx.after), I.none) : t.fold(I.none, S(I.some, xx.before), I.none, S(I.some, xx.end)),
        Ux = (e, t, n) => {
            const o = e ? 1 : -1;
    ...
    const ik = (e, t, n, o, r, s) => {
        ...
        Ek = (e, t, n) =>
            ...
            ((e, t) => {
                ...
                return (
                    !!((e) => w(e.selection.getSel().modify))(t) && (e && jr(o) ? Ux(!0, t.selection, o) : !(e || !Hr(o)) && Ux(!1, t.selection, o))
                );
            })(e, t),
        Sk = (e) => {
            const t = Oa(null),
        ...
        Gk = (e) =>
            G(
                ...
                (e) => !Kk(e) && !((e) => Nn(e).exists(Kk))(e) && Xn(e, (e) => rr(e.dom) || sr(e.dom)).exists((e) => rr(e.dom))
            ),
        Yk = (e, t) => {
            var n, o;
            const { dom: r } = e,
    ...
    const uS = (e, t, n) => (e.stype === cS.Error ? t(e.serror) : n(e.svalue)),
        ...
        WS = (e, t, n) =>
            VS(
                ...
                ((e) => {
                    return (
                        (t = (t) => (H(e, t) ? nl.value(t) : nl.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`))),
                        kS((e) => t(e).fold(fS, mS))
                    );
                    var t;
                })(n)
    ...
    const hN = N('x-tinymce/html'),
        ...
        UN = (e, t, n, o) => {
            ...
            const s = MN(t, hN()) || yN(n),
                a =
                    !s &&
                    ((e) => !/<(?:\/?(?!(?:div|p|br|span)>)\w+|(?:(?!(?:span style="white-space:\s?pre;?">)|br\s?\/>))\w+\s[^>]+)>/i.test(e))(r),
                i = RN(r);
    ...
    const sR = (e, t) => Math.abs(e.left - t),
            ...
            ((e) =>
                ...
                (t) => {
                    const { pass: n, fail: o } = K(e, (e) =>
                        ((e, t) => {
                            const n =
                                ((e, t) => Math.max(0, Math.min(e.bottom, t.bottom) - Math.max(e.top, t.top)))(e, t) / Math.min(e.height, t.height);
                                    ...
                                    const t = (t) => {
                                            if (!t.isDefaultPrevented()) {
                                                ...
                                                n &&
                                                    ...
                                                    (t.preventDefault(), 'drop' === t.type && aw(e, 'Dropped file type is not supported'));
                                            }
                                        },
                                        n = (n) => {
                                            ig(e, n.target) && t(n);
                    ...
                    const s = Math.max(0, n.startOffset),
                        ...
                        l = ((e, t, n, o) => {
                            ...
                            return ((e, t) => {
                                ...
                                .map((e) =>
                                    Dt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: MR(s, s.getRoot(), t, 0, t, 0, true) }]
                                )
                                .getOr([]);
                        })(e, o, a);
                    return (
                                ...
                                e.execCommand('mceInsertNewLine'),
                                    n.each((t) => {
                                        ...
                                        n.data.charAt(t.offset - 1) === cr &&
                                            (n.deleteData(t.offset - 1, 1), UR(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
                                    });
                            }
                        ),
                        !0)
        ...
        fA = (e) => {
            ...
            (o.disabled = !0),
                (e.readonly = yd(e)),
                e.readonly ||
                    (e.inline && 'static' === sA.getStyle(o, 'position', !0) && (o.style.position = 'relative'), (o.contentEditable = 'true')),
                (o.disabled = !1),
                (e.editorUpload = bw(e)),
                (e.schema = ia(dA(e))),
                (e.dom = Na(n, {
    ...
    class RO {
        ...
        save(e = {}) {
            ...
            const s = { ...o, content: r };
            if ((s.no_events || t.dispatch('SaveContent', s), 'raw' === s.format && t.dispatch('RawSaveContent', s), (r = s.content), Yo(n)))
                n.value = r;
            else {
    ...
    const PO = (e) => {
        ...
        LO = (e) => {
            if (e !== BO) {
                const t = Na.DOM;
                e ? (t.bind(window, 'resize', PO), t.bind(window, 'scroll', PO)) : (t.unbind(window, 'resize', PO), t.unbind(window, 'scroll', PO)),
                    (BO = e);
            }
        },
        MO = (e) => {
